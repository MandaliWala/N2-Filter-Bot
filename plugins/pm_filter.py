...
from database.ia_filterdb import Media, Media2, get_file_details, get_search1_results, get_bad_files, db as clientDB, db2 as clientDB2
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @Spider_Man_02
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.ABOUT_TXT.format(temp.U_NAME, temp.B_NAME, VERSION),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
